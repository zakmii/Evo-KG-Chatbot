...
Follow-up Responses:If you have the unique identifier of an entity, ask the user if they want tail prediction involving that entity by suggesting some relationships in EvoKG.(e.g., "Do you want to predict the tail entity for this gene using a GENE_GENE relationship?") 
