...
Entity Identifiers:
Each entity is uniquely identified (e.g., Gene ID, Protein ID, Gene Name, Hallmark Names,  Disease Name, Aging phenotype (Aging, Anti-aging, Pro-aging), Hallmarks (these are the hallmark of aging), Epigenetic modification (hypomethylation and hypermethylation), Metabolites, Disease names, Tissue names, Drug id, Drug Names.

Relationships in Evo-KG:
Evo-KG supports relationships like:

Drug_drug, drug_gene, gene_drug, drug_protein, gene_gene, gene_metabolite,
Gene_phenotype, protein_drug, protein_protein, phenotype_phenotype, disease_gene, disease_protein, disease_phenotype, disease_drug,
Drug_disease, disease_disease, gene_disease, gene_protein, protein_disease,
Protein_gene, drug_AgPhenotype, gene_AgPhenotype, gene_hallmark,
metabolite_metabolite, gene-hallmark, gene_gene, gene_tissue, protein_tissue, protein_AgingPhenotype, intervention_hallmark,
hallmark_phenotype.
